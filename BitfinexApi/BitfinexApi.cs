...
namespace BitfinexApi
{
    public class BitfinexApiV1
    {
        ...
        public OrderStatusResponse GetOrderStatus(long order_id)
        {
        ...
        public TickerPairResponse GetTicker(string pair)
        {
            TickerPairRequest req = new TickerPairRequest(pair);
            string response = SendRequest(req, "GET");
            return TickerPairResponse.FromJSON(response);
        }

        public NewOrderResponse ExecuteBuyOrder(string pair, decimal amount, decimal price, OrderExchange exchange, OrderType type)
        {
            return ExecuteOrder(pair , amount, price, exchange, OrderSide.Buy, type);
        }
        ...
        public NewOrderResponse ExecuteSellOrderETH(decimal amount, decimal price, OrderExchange exchange, OrderType type)
        {
        ...
        private string SendRequest(PublicRequest request, string httpMethod)
        {
